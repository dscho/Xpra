...
%if %{defined Fedora}
%define requires_extra , libvpx, x264-libs
%endif
...
%changelog
* Sat Oct 13 2012 Antoine Martin <antoine@nagafix.co.uk> 0.3.12-1
...
* Sat Sep 08 2012 Antoine Martin <antoine@nagafix.co.uk> 0.3.9-1
- fix man page typo
